<!DOCTYPE html>
 <!-- Mockup for LINGsCARS -->
<html lang="en">
    <head>
        <title>ALL about LING | LINGsCARS</title>
...
?>
        ...
        <main class="about-ling-content">
            <article>
                <div>
                    <div style="display: flex; align-items: center; flex-wrap: wrap; margin-right: 16px;">
                        <img style="flex-basis: 70px; margin-right: 0.67em; max-width: 70px;" src="./img/ling/ling_stand3.jpg" alt="Ling's Picture">
                        <div>
                            <h1 style="margin-top: 0;">
                                Hello! I am Ling! &#129311;&#128526; 
                            </h1>
                            <p>
                                I'm the UK's <b>&#128170;hardest&#128170;</b> working car leasing provider, and I run LINGsCARS &#128664;, the UK's favourite car leasing website&#128150;.
                            </p>
                            <p>
                            ...
                            <p>
                                I treat customers like <strong>adults</strong>, not like <strong>idiots</strong>&#129313;.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="title">
                    ...
                    <ul>
                        <li>
                            &#9658; <a href="#interview">Interview with Ling</a>
                        </li>
                        <li>
                            &#9658; <a href="#visit-china">Visit China?</a>
                        </li>
                        <li>
                            &#9658; <a href="#sales-skill">Contract Hire Car Sales Skills</a>
                        </li>
                        <li>
                            &#9658; <a href="#expand-site">Expand LINGsCARS.com?</a>
                        </li>
                        <li>
                            &#9658; <a href="#supplier">Suppliers</a>
                        </li>
                        <li>
                            &#9658; <a href="#more-about">More about Ling</a>
                        </li>
                        <li>
                            &#9658; <a href="#publicity">Press and Publicity</a>
                        </li>
                        <li>
                            &#9658; <a href="#chinese-in-uk">Chinese in UK Contract Hire Business?</a>
                        </li>
                        <li>
                            &#9658; <a href="#ling-character">Ling's Character</a>
                        </li>
                    </ul>
                </div>
            </article>
            ...
            <article>
                <div class="title">
                    <h2>
                        Contract Hire Car Sales Skills
                    </h2>
                </div>
                <div>
                    <p>
            ...
            <article>
                <div class="title">
                    <h2>
                        Chinese in UK Contract Hire Business?
                    </h2>
                </div>
                <div>
                    <p>
